...
function FruitPurchase() {
    ...
    const [fruitPurchases, setFruitPurchases] = useState<FruitPurchase[] | []>([
        { fruitId: 0, amount: 0 },
    ]);
    useEffect(() => {
    ...
    const isFormValid = (): boolean => {
        return (
            ...
            fruitPurchases.every((fruit) => fruit.fruitId !== 0 && fruit.amount > 0)
        );
    };
    ...
    const handleFruitPurchaseChanges = (
        index: number,
        property: 'fruitId' | 'amount',
        value: number
    ) => {
                        ...
                        <Row key={index}>
                            <Col>
                                <Select
                                    ...
                                    value={fruit.fruitId}
                                    onChange={(e) =>
                                        handleFruitPurchaseChanges(index, 'fruitId', e.target.value)
                                    }
                            ...
                            <Col>
                                <Input
                                    ...
                                    value={fruit.amount}
                                    onChange={(e) =>
                                        handleFruitPurchaseChanges(index, 'amount', e.target.value)
                                    }
                                />
                            </Col>
                        </Row>
